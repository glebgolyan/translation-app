...
export function OrderForm({
  ...
  const addOriginalFiles = useCallback(
    (files: File[]) => {
  ...
  return (
    ...
    >
      ...
      >
        <Grid
          gridTemplateColumns={{ base: '1fr', md: '1fr', lg: '1.2fr 1fr', xl: '1.2fr 1fr' }}
          gap={4}
        >
          <Flex
            flexDir='column'
          ...
          <Flex flexDir='column'>
            ...
            >
              <FileSection
                ...
                onRemoveLocal={(i) =>
                  setOriginalLocal((prev) => prev.filter((_, idx) => idx !== i))
                }
                onRemoveExisting={(filePath, index) =>
                  handleDeleteExisting(filePath, index, 'original')
                }
              ...
              {(isManagerOrAdmin || userRole === 'TRANSLATOR') && (
                <>
                  ...
                  <FileSection
                    ...
                    onRemoveLocal={(i) =>
                      setTranslatedLocal((prev) => prev.filter((_, idx) => idx !== i))
                    }
                    onRemoveExisting={(filePath, index) =>
                      handleDeleteExisting(filePath, index, 'translated')
                    }
                    canUpload={true}
                  />
                </>
