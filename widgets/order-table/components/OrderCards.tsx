                ...
                <GridItem key={order.id}>
                    ...
                    >
                        ...
                        <Grid gridTemplateColumns='repeat(2, 1fr)' gap={4}>
                            {/* Date received */}
                            <Box>
                                <Text fontSize="10px" color={labelColor} fontWeight="600" textTransform="uppercase" letterSpacing="0.06em" mb={0.5}>
                                    {t('orders.received')}
                                </Text>
                                <Text fontSize="13px" fontFamily="mono" color="gray.200">{new Date(order.createdAt).toLocaleDateString('uk-UA')}</Text>
                            </Box>
                            ...
                            <Box>
                                ...
                                <Text fontSize="13px" fontFamily="mono" color={isLate ? 'red.500' : 'gray.200'} fontWeight={isLate ? '600' : '400'}>
                            ...
                            {order.documentType && (
                                <Box>
                                    ...
                                    <Text fontSize="12px" color={valueColor} noOfLines={1}>
                                        {order.documentType}
                                    </Text>
                                </Box>
                            )}
                        ...
                        <Divider borderColor={borderColor} mt={3} mb={3} />
