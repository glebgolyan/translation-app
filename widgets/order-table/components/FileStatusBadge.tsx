...
export function FileStatusBadge({
    ...
    if (filesDeletedAt) {
        return (
            <Tooltip
                ...
                fontSize="12px"
            >
                <Text textAlign='center'><Icon as={RiAlertLine} boxSize={4} color="orange.400" cursor="help" /></Text>
            </Tooltip>
        );
    }
    ...
    if (totalFiles === 0) {
        return (
            <Tooltip
                ...
                fontSize="12px"
            >
                <Text textAlign='center'><Icon as={RiFile3Line} boxSize={4} color="gray.300" cursor="help" /></Text>
            </Tooltip>
        );
    }
    ...
    return (
        <Tooltip
            ...
            fontSize="12px"
        >
            <Text textAlign='center'><Icon as={RiFile3Line} boxSize={4} color="blue.400" cursor="help" /></Text>
        </Tooltip>
    );
}