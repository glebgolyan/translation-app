...
import {
    ...
    Center, Spinner, Text, useColorModeValue, useBreakpointValue, Grid,
...
import {OrderCard} from "@/widgets/order-table/components/OrderCards";
        ...
        <Box>
            ...
            {(isMobile) ? (
                <Grid templateColumns={{base: "1fr", lg:"repeat(2, 1fr)"}}  gap={4}>
                    {orders.map(order => (
                        <OrderCard order={order} visibleColumns={visibleColumns} userRole={userRole} onView={onView}
                                   onEdit={onEdit} onDelete={onDelete} key={order.id}/>
                    ))}
                </Grid>
            ) : (
                                        ...
                                        >
                                            <Flex align="center" gap={1}>
                                                ...
                                                {filters.sortBy === col.key && (
                                                    <Icon as={filters.sortOrder === 'asc' ? RiSortAsc : RiSortDesc}
                                                          boxSize={3}/>
                                                )}
                                            </Flex>
                                        </Th>
