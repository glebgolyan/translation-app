...
import {
    ...
    Text,
    VStack,
    Link as ChakraLink, useColorModeValue, useToast
...
export function LoginPageContent() {
    ...
    return(
        <Box flex={1} display="flex" alignItems="center" justifyContent="center" px={8} bg={bg}>
            <Box w="100%" maxW="380px">
                <Box mb={8}>
                    <Text color={labelColor} fontFamily="Syne" fontWeight="800" fontSize="28px" letterSpacing="-0.02em" mb={2}>
                        Welcome back
                    </Text>
