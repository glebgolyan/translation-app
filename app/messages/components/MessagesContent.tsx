'use client';
import { Box, Flex, Text, useColorModeValue, VStack, HStack } from '@chakra-ui/react';
...
export function MessagesContent({ user }: { user: User }) {
          ...
          {selectedConversation ? (
            ...
            >
              ...
              <Box
                ...
                w='100%'
              >
                <Messenger orderId={selectedConversation.id} />
              </Box>
            </VStack>
          ) : (
            <Flex
