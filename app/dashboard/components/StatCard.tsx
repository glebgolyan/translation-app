'use client';
import { Box, Flex, Stat, StatLabel, StatNumber, StatHelpText, StatArrow, Icon, useColorModeValue } from '@chakra-ui/react';
        ...
        <Box bg={bg} borderRadius="8px" p={{base: 3, md: 6}} border="1px solid" borderColor={borderColor}>
            <Flex justify="space-between" align="flex-start">
                <Stat>
                    ...
                    {change !== undefined && (
                        <StatHelpText fontSize="12px" color={helpColor} mt={1}>
