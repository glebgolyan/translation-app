...
import {
    ...
    FormControl, FormLabel, Input, VStack, Text, useToast,
    useColorModeValue,
                ...
                <ModalBody>
                    <VStack spacing={4}>
                        <Text fontSize="13px" color={labelColor}>
                            {mode === 'download'
                                ? t('orders.selectDateRangeDownload') || 'Select a date range to download all files from orders'
                                : t('orders.selectDateRangeDelete') || 'Select a date range to delete all files from orders'}
                        </Text>

                        <FormControl>
                            <FormLabel fontSize="13px" color={labelColor}>From</FormLabel>
                            <Input
                                type="date"
                                value={dateFrom}
                        ...
                        <FormControl>
                            <FormLabel fontSize="13px" color={labelColor}>To</FormLabel>
                            <Input
                                type="date"
                                value={dateTo}
                        ...
                        {mode === 'delete' && (
                            <Box
                                ...
                                borderColor="red.500"
                            >
                                <Text fontSize="12px" color="red.600" _dark={{ color: 'red.200' }}>
                                    ⚠️ {t('orders.deleteWarning') || 'This action cannot be undone. All files in this date range will be permanently deleted.'}
                                </Text>
                            </Box>
                        )}
                    </VStack>
